...
if(isset($params->fromDate) && isset($params->toDate))
{
 ...
 $sql = "SELECT  a.patient_name,a.patient_contact,a.appointment_date,a.appt_id,pb.* 
from provider_billing pb,appointments a
where  pb.provider_id= a.provider_id Group by bill_id 
and pb.provider_id= '$providerId'
