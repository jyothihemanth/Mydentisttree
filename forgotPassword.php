...
if (isset($_REQUEST['email'])  && isset($_REQUEST['forgotPassActToken']) && isset($_REQUEST['id']))
 {
 $email = $_REQUEST['email'];
 $forgotPassActToken = $_REQUEST['forgotPassActToken'];
 $userId = $_REQUEST['id'];
 // $key = $_REQUEST['key'];

  $sql1 = "SELECT * FROM user_mst WHERE email = '$email' AND user_id = '$userId' AND forgot_password_activation_token = '$forgotPassActToken' ";
  // echo $sql1;
 ...
 if($password === $cPassword)
                   {
      	                 ...
      	                 $forgotPassActToken = bin2hex(openssl_random_pseudo_bytes(16));
      	                 $accessToken = bin2hex(openssl_random_pseudo_bytes(16));

                     	$sql = "UPDATE user_mst SET password = '$password', access_token = '$accessToken',forgot_password_activation_token = '$forgotPassActToken' WHERE email = '$email' AND user_id = '$userId'"; 
...
<html lang="en">
<head>
	<title>Mydentist-password recovery </title>
	<meta charset="UTF-8">
